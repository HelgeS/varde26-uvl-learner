"""Graph/conjunction-aware bias and custom CA components.

A networkx-backed bias that generates richer n-ary candidates (alternative/or
group templates) together with the custom pycona components that consume it:
GFindScope2, GFindC2, GPQGen, GQuAcq, and the TrackAndCacheCAEnv environment.
"""
...
class TrackAndCacheCAEnv(ActiveCAEnv):
    def __init__(self):
        ...
        self.n_negative = 0
        self.n_cache_hit = 0
        # The graph CA components handle n-ary clauses natively (no skip-collapse),
        # so no collapses are ever skipped — but the runner reads this attribute.
        self.n_skipped = 0
        self.query_cache = {}
